...
const User = ({ user, editUser, deleteUser, even }) => {
  return (
    <tr key={user.id} className={`hover:bg-blue-100 transition-colors duration-200 ease-in-out text-gray-700 ${even ? "bg-gray-100" : "bg-white"}`}>
      ...
      <td className="text-left p-3 whitespace-nowrap border border-gray-300">
        <div className="font-semibold"> <span className="capitalize">{user.prenom}</span> <span className="capitalize">{user.nom}</span></div>
      ...
      <td className="text-left p-3 whitespace-nowrap border border-gray-300">{user.num_tel}</td>
      <td className="text-left p-3 whitespace-nowrap border border-gray-300">
        {user.date_naissance}
      </td>
      <td className="text-left p-3 whitespace-nowrap border border-gray-300">
